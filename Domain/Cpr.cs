...
public static class Cpr 
{
    ...
    public static (int, double, double) decodeCPRairborne(int even_cprlat, int even_cprlon,
                      ...
                      bool fflag)
    {
        ...
        { // Use odd packet.
            ...
            rlon = cprDlonFunction(rlat1, true, false) * (cprModInt(m, ni) + lon1 / 131072);
            rlat = rlat1;
        }
        else
        {     // Use even packet.
            ...
            rlon = cprDlonFunction(rlat0, false,false ) * (cprModInt(m, ni) + lon0 / 131072);
            rlat = rlat0;
        }
    ...
    static double cprDlonFunction(double lat, bool fflag, bool surface)
    {
